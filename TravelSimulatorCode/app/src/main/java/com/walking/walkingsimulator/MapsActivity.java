...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener {
    ...
    public void onMapClick(LatLng latLng) {
        ...
        myDes = new LatLng(latLng.latitude, latLng.longitude);
        mMap.addMarker(new MarkerOptions().position(myDes).title("Destination"));

        String url =   makeURL(myLoc.latitude, myLoc.longitude, myDes.latitude, myDes.longitude);
